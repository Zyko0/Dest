...
var (
	impls = [ItemMax]*Definition{
		...
		Extra_shot: {
			...
			Hand:        SingleHand,
			Name:        "Extra shot",
			Description: "Shoots an additional projectile with your %.",
			MaxStacks:   10,
		...
		Sabotage: {
			...
			Hand:        None,
			Name:        "Sabotage",
			Description: "Add 5 extra random curses spread among current items present on the floor.",
			MaxStacks:   InfiniteStacks,
		...
		Love: {
			...
			Hand:        SingleHand,
			Name:        "Love",
			Description: "When your %s hits the target, the target is pulled closer to you by an additional step (inverse knockback).",
			MaxStacks:   InfiniteStacks,
